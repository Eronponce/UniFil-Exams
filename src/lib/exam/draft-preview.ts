...
const DRAFT_ANSWER_KEY_PLACEHOLDER_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="420" height="1200" viewBox="0 0 420 1200" role="img" aria-label="GABARITO PLACEHOLDER temporário"><rect width="420" height="1200" fill="#f8fafc"/><rect x="18" y="18" width="384" height="1164" rx="12" fill="#fff" stroke="#64748b" stroke-width="3"/><text x="210" y="112" fill="#0f172a" font-family="Arial,sans-serif" font-size="34" font-weight="700" text-anchor="middle">GABARITO</text><text x="210" y="154" fill="#475569" font-family="Arial,sans-serif" font-size="18" font-weight="700" text-anchor="middle">PLACEHOLDER TEMPORÁRIO</text><line x1="56" y1="184" x2="364" y2="184" stroke="#cbd5e1" stroke-width="2"/><g fill="none" stroke="#64748b" stroke-width="2">${Array.from({ length: 16 }, (_, index) => { const y = 228 + index * 54; return `<circle cx="82" cy="${y}" r="13"/><circle cx="138" cy="${y}" r="13"/><circle cx="194" cy="${y}" r="13"/><circle cx="250" cy="${y}" r="13"/><circle cx="306" cy="${y}" r="13"/>`; }).join("")}</g><text x="210" y="1104" fill="#64748b" font-family="Arial,sans-serif" font-size="16" text-anchor="middle">Pré-visualização — não persistido</text></svg>`;
